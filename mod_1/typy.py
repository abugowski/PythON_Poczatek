...
print('float from str:', float_from_str, ' Type:', type(float_from_str), sep='\t\t')
...
str_value = "Andrzej"
print('str value:', str_value, ' Typ:', type(str_value), sep='\t\t')

str_from_int = str(35)
print('str from int:', str_from_int, '\t Typ:', type(str_from_int), sep='\t\t')
